...
describe("test TodoCreate", () => {
  test("render TodoCreate", async () => {
    const handleClick = jest.fn();
    render(<BrowserRouter>
        <Routes>
          <Route path="/" element={<TodoCreate resourceType="todos" openNotification={openNotification} onSubmit={handleClick} />} />
        </Routes>
      </BrowserRouter>);
